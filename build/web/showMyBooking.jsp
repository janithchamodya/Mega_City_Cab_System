<%-- 
    ...
    Created on : Feb 22, 2025, 8:33:27 PM
    Author     : OZT00106
--%>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="showMyBooking.jsp">View My Booking</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- End of Topbar -->
                <div class="container mt-5">
                    <h2 class="text-center">Show My Booking</h2>
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <c:forEach var="mybookings" items="${mybookingsList}">
                                <tr>
                                    <form >
                                        <td>
                                            <input readonly type="text" name="orderNumber" value="${mybookings.orderNumber}" class="form-control" />
                                        </td>
                                        <td>
                                            <input readonly type="text" name="model" value="${mybookings.model}" class="form-control" />
                                        </td>
                                        <td>
                                            <input readonly type="text" name="vehicleName" value="${mybookings.vehicleName}" class="form-control" />
                                        </td>
                                        <td>
                                            <input readonly type="text" name="vehicleNumber" value="${mybookings.vehicleNumber}" class="form-control" />
                                        </td>
                                        <td>
                                            <input readonly type="text" name="driverName" value="${mybookings.driverName}" class="form-control" />
                                        </td>
                                        <td>
                                            <input readonly type="text" name="amount" value="${mybookings.amount}" class="form-control" />
                                        </td>
                                        <td>
                                            <input readonly type="text" name="startDate" value="${mybookings.startDate}" class="form-control" />
                                        </td>
                                        <td>
                                            <input readonly type="text" name="endDate" value="${mybookings.endDate}" class="form-control" />
                                        </td>
