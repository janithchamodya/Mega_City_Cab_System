<%-- 
    Document   : changeSuperAdminData
    Created on : Feb 10, 2025, 2:14:26 PM
    Author     : OZT00106
--%>

<%-- 
    Document   : changeAddminData
    Created on : Feb 10, 2025, 10:14:01 AM
    Author     : OZT00106
--%>
...
<body id="page-top">
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Super Addmin Change</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container mt-5">
                <h2 class="text-center">Super Admin Management</h2>
 ...
 <script type="text/javascript">
                    <% 
                        ...
                        if (error != null) { 
                    %>
                        // Call showError function to display error based on the error code
                        showError(<%= error %>);
                    <% 
                        } else if (success != null) { 
                    %>
                        // Call showSuccess function if success parameter is present
                        showSuccess(<%= success %>);
                    <% 
                        }
                    %>
