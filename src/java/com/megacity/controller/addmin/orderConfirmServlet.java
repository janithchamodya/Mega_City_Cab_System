...
public class orderConfirmServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        double vehicleWithoutAC = Double.parseDouble(request.getParameter("vehicleWithoutAC"));
         ...
         String OrderNum = "Ord_" + shortTimestamp;
         String customerName =userName; 
         
         int vehicleid=(vehicleService.getvehicaleID(vehicleNumber)).getId();
         Bookings bookings=new  Bookings( OrderNum,userId,vehicleid,driverId,customerName,model, vehicleName, vehicleNumber, vehicleOwner, driverName,driverGender, amount, startDate, endDate);
